<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 ">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('dashboard.new') }}">
                        @csrf
                        ...
                        <div class="grid gap-4 lg:grid-cols-3 md:grid-cols-2">
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="item" class="block w-full" type="text" name="item" :value="old('desc')"  required autofocus onkeyup="this.value = this.value.toUpperCase();" />
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="description" class="block w-full" type="text" name="description" required />
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <select id="quantification" name="quantification"  class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full" required>
                                    <option selected disabled>Select Item Quantification</option>
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="quantity" class="block w-full" type="number" name="quantity"
                                onkeyup="calculatePrice()" required/>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="priceperquantification" class="block w-full" type="number" name="priceperquantification"
                                onkeyup="calculatePrice()" step="any" required/>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="totalprice" class="block w-full" type="number" name="totalprice" step="any" required />
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="acquisitiondate" class="block w-full" type="date" name="acquisitiondate" required />
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <x-input id="propertynumber" class="block w-full" type="text" name="propertynumber" onkeyup="this.value = this.value.toUpperCase();" placeholder="Leave Blank if Not Available"/>
                            </div>
                        ...
                        <div>
                            <div class="flex items-center justify-end mt-4" id="tes">            
                                <x-button class="ml-4">
                                    {{ __('Add to Inventory') }}
                                </x-button>
                            </div>
    ...
    {{-- Duplicate Modal --}}
    @if(session()->has('duplicateItemName'))
    <div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-data="{ show: true }" x-show="show">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                <strong class="font-bold">{{ session()->get('duplicateItemName') }} with Property Number: {{ session()->get('duplicateItemPN') }}</strong>
                            </h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Already Exist in Inventory!
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">      
                    ...
                    <a class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" href="/dashboard/update/{{ session()->get('duplicateItemID')}}">
                        View Item
                    </a> 
                </div>
            </div>
